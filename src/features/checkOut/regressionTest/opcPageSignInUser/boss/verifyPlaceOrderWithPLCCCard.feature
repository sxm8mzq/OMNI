Feature: Signed In User Place Order With PLCC Card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @opcPagesignInUser @boss @plcc
  Scenario Outline: Signed in user should able to place order with plcc card
    ...
    Examples:
      | email                     | password |
      | finn.mckenzie86@gmail.com | Test@123 |
