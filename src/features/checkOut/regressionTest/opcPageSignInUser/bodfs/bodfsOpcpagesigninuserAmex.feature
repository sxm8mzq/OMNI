Feature: Opc Page signin user place BODFS Order with Amex

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @opcPagesignInUser @bodfs @amex
  Scenario Outline: Registered user should able to buy BODFS as signIn user from OTC page placing order with Amex in EN
    ...
    Examples:
      ...
      | brandt75@yahoo.com | Test@123 | Testuser  | WebdriverIO | 428 Ellesmere Road | Scarborough | Ontario  | 4123456789 | M1R 4E6    |
