Feature: Opc Page signin user place Order with Paypal

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @opcPagesignInUser @sth @paypal
  Scenario Outline: Registered user should able to buy STH as signIn user from OTC page placing order with Paypal in EN
    ...
    Examples:
      | email             | password | paypalUserName  | paypalPassword | firstName | lastName    | address            | city        | province | phone      | postalCode |
      | marty51@gmail.com | Test@123 | cabuyer2@thd.ca | 11111111       | Testuser  | WebdriverIO | 428 Ellesmere Road | Scarborough | Ontario  | 4704243224 | M1R 4E6    |