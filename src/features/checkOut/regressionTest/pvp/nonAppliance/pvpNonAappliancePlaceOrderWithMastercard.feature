Feature: HomePage SignedIn Pro User Place PVP Non Appliance Order With Mastercard

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @masterCard @homePageSignedInUser @nonAppliance @pvp
  Scenario Outline: Registered pro user should be able to place pvp non appliance order with mastercard
    ...
    Then the user enters text "50" in the textbox "Qty"
