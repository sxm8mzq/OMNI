Feature: Registered User Appliance place order parts and service for Visa card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @homePageNewRegisteredUser @appliance @visaCard
  Scenario Outline: Registered user should able to place order parts and service for Visa card
