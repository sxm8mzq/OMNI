Feature: Place Order With Paypal BODFS

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @homePageSignedInUser @bodfs @paypal
  Scenario Outline: User should able to place order with paypal bodfs
    ...
    Then the user waits for webelement "hdca-product__gallery" with html attribute "class" to be visible
    ...
    Then the user verify and select checkbox "Save and use as my billing address"
    ...
    Then the user clicks on the webelement with html tag "id" as "payment-submit-btn"
    ...
    Examples:
      | email                        | password | firstName | lastName    | address          | city        | province | postalCode | phoneNum   | payPalEmail     | payPalPassword |
      | lurline_vandervort@yahoo.com | Test@123 | Testuser  | WebdriverIO | 428 ELLESMERE RD | Scarborough | Ontario  | M1R 4E6    | 4704243224 | cabuyer2@thd.ca | 11111111       |