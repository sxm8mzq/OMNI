Feature: Place Order With HD Commercial BODFS

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @homePageSignedInUser @bodfs @hdcc
  Scenario Outline: User should able to place order with hd commercial bodfs
    ...
    Examples:
      ...
      | manuel_russel@gmail.com | Test@123 | Scoring   | Samuel   | 621 Rue Habel | Lavaltrie | Quebec   | 4123456789 | J5T 2A1    |