Feature: Place Order With PLCC Card BOSS
 
  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @homePageSignedInUser @boss @plcc
  Scenario Outline: User should able to place order with plcc card BOSS
    ...
    Then the user waits for text " Hi John, My Account " to be visible
    ...
    Then the registered user fills in "<phone>" at checkout page
    ...
    Examples:
      ...
      | maurice1@hotmail.com | Test@123 | 4704243224 |