Feature: Signed In User Place Order With Visa Card STH

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @homePageSignedInUser @sth @visaCard
  Scenario Outline: Registered user should able to Place Order With Visa Card STH
    ...
    Then the user waits for text "First Name" to be visible
    ...
    Examples:
      | email                    | password | address            | city        | province | postalCode | phone      | firstName  | lastName |
      | marcia_keeling@yahoo.com | Test@123 | 428 Ellesmere Road | Scarborough | Ontario  | M1R 4E6    | 4704243224 | King       | Luther    |