Feature: HomePage SignedIn User Place Appliance Order With Mastercard

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @masterCard @homePageSignedInUser @appliance
  Scenario Outline: Registered user should be able to place appliance order with mastercard
    ...
    Examples:
      ...
      | alana.farrell@hotmail.com | Test@123 | Testuser  | WebdriverIO | 480 Ellesmere Rd | Scarborough | Ontario  | M1R 4E6    | 4704243224 |