Feature: Verify Registered User is able to order bopis with Master Card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @guestUser @bopis @masterCard @opcPageNewRegUser
  Scenario Outline: Registered User should able to order bopis with Master Card
