Feature: Registered User BODFS place order with Master card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @bodfs @masterCard @opcPageNewRegUser
  Scenario Outline: Registered User should able to Place Order with Master card for BODFS
    ...
    Then the user selects same day delivery fulfillment
    ...
    Then the user enters the text "<password>" in the textbox " Password " at index "5"
