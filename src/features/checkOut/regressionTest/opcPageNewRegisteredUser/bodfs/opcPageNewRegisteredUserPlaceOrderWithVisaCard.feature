Feature: Registered User BODFS place order with Visa card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @registeredUser @bodfs @expressDelivery @visaCard @opcPageNewRegUser
  Scenario Outline: Registered User should able to Place Order with Visa card for BODFS
