Feature: Guest User Appliance Place Order With HD Commercial Card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @guestUser @appliance @hdcc
  Scenario Outline: User should able to place order with hd commercial card
    ...
    Examples:
      | firstName | lastName   | address            | city        | province | postalCode | phone      | extension |
      | Testuser  | Automation | 428 Ellesmere Road | Scarborough | Ontario  | M1R 4E6    | 4704243224 | 8921      |