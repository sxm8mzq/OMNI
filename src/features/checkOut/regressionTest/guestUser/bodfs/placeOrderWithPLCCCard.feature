Feature: Guest User BODFS Place Order With PLCC Card

  Background: User launches url
    Given the user launches the url

  @checkOut @mCycle @regressionTest @guestUser @bodfs @expressDelivery @hdcc
  Scenario Outline: User should able to Place Order with PLCC Card
    ...
    Examples:
      ...
      | Luther    | King     | 428 Ellesmere road | Scarborough | Ontario  | 2365678914 |