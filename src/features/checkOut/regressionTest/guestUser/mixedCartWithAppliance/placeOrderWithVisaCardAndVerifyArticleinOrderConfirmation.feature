Feature: Verify place order with visa card and verify article in order confirmation

  Background: User launches url
    Given the user launches the url

  @checkOut @regressionTest @guestUser @mixedCartWithAppliance @visaCard @cswe
  Scenario Outline: User should able to verify place order with visa card and verify article in order confirmation
    ...
    Examples:
     | bodfs      | sth        | appliance  | firstName | lastName    | address            | city        | province | postalCode | phone      |
     | 1001031371 | 1001131750 | 1001075809 | Testuser  | WebdriverIO | 428 Ellesmere Road | Scarborough | Ontario  | M1R 4E6    | 4704243224 |