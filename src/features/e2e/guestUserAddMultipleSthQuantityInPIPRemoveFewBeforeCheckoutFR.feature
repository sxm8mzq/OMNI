Feature: Guest User Add Multiple STH Quantity In PIP And Remove Few Before Checkout In French

  Background: User launches url
    Given the user launches the url

  @e2e @regressionTest @guestUser @amex @sth @mCycle
  Scenario Outline: Guest user should able to add multiple quantity in pip and remove few before checkout in french
