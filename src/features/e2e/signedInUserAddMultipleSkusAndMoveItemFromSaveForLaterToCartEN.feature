Feature: SignedIn User Can Add Multiple Skus BOSS, BODFS And STH To Cart, Move Item From Save For Later To Cart In English
  ...
  Scenario Outline: Registered user can add multiple skus boss, bodfs and sth to cart, move item from save for later to cart before checkout
    ...
    Examples:
      ...
      | abbigail86@yahoo.com | Test@123 | 1000720454 | 1000100110 | 1000791787 | James     | Evans    | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4123456792 |