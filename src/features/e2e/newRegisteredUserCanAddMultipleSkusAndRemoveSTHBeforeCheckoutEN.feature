Feature: New Registered User Can Add Multiple Skus BOSS, BOPIS, BODFS, Appliance And STH To Cart, Remove STH Before Checkout From Cart In English
  ...
  Scenario Outline: New registered user can add multiple skus boss, bodfs, appliance and sth to cart, remove sth before checkout from cart
    ...
    Examples:
      ...
      | 1000720454 | 1000657245 | 1000741513 | 1001024820 | 1000791787 | James     | Evans    | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4123456792 | Test@123 |