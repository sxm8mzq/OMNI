Feature: Signed In User Add Multiple Items From FBT In English
  ...
  Scenario Outline: Registered user should able to add multiple appliances from fbt
    ...
    Examples:
      ...
      | asha.williamson93@hotmail.com | Test@123 | Clark     | Chen     | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4704243296 |