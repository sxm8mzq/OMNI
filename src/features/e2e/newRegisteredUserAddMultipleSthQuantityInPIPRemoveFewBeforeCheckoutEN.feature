Feature: New Registered User Add Multiple STH Quantity In PIP And Remove Few Before Checkout In English

  Background: User launches url
    Given the user launches the url

  @e2e @regressionTest @newRegisteredUser @masterCard @sth @mCycle
  Scenario Outline: New registered user should able to add multiple quantity in pip and remove few before checkout in english
