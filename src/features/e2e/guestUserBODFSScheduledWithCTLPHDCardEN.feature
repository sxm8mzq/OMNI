Feature: Guest User BODFS Scheduled With CTLP HD Card In English

  Background: User launches url
    Given the user launches the url

  @e2e @regressionTest @bodfs @guestUser @hdca @mCycle
  Scenario Outline: Guest user should able to buy a bodfs scheduled with ctlp hd card in english
