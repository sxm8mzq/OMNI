Feature: New Registered User Can Add Multiple Skus BOSS, BOPIS, BODFS And STH To Cart, Move BOSS To Save For Later Before Checkout From Cart In English

  Background: User launches url
    Given the user launches the url

  @e2e @regressionTest @boss @bopis @bodfs @sth @registeredUser @masterCard @mCycle
  Scenario Outline: New registered user can add multiple skus boss, bopis, bodfs and sth to cart, move boss to save for later before checkout from cart
    ...
    Examples:
      | Boss       | Bopis      | Bodfs      | Sth        | firstName | lastName | postalCode | address            | city        | province | phoneNum   | password |
      | 1000720454 | 1000657245 | 1000100110 | 1000791787 | James     | Evans    | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4123456792 | Test@123 |