Feature: Signed In User Can Add Multiple Skus BOSS, BOPIS, BODFS, Appliance And STH To Cart, Remove STH Before Checkout From Cart In French
  ...
  Scenario Outline: Registered user can add multiple skus boss, bodfs, appliance and sth to cart, remove sth before checkout from cart
    ...
    Examples:
      ...
      | merl.huel6@yahoo.com | Test@123 | 1000720454 | 1000657245 | 1000100110 | 1001024820 | 1000791787 | James     | Evans    | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4123456792 |