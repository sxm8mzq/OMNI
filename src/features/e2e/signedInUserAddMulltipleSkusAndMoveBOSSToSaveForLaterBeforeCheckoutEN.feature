Feature: Signed In User Can Add Multiple Skus BOSS, BOPIS, BODFS And STH To Cart, Move BOSS To Save For Later Before Checkout From Cart In English
  ...
  Scenario Outline: Registered user can add multiple skus boss, bopis, bodfs and sth to cart, move boss to save for later before checkout from cart
    ...
    Examples:
      ...
      | edwina55@gmail.com | Test@123 | 1000720454 | 1000657245 | 1000100110 | 1000791787 | James     | Evans    | M1R 4E6    | 428 Ellesmere Road | Scarborough | Ontario  | 4123456792 |