Feature: New Registered User Add Multiple Items To Wishlist Add Selected Item To Cart Remove Wishlist And Checkout In French

  Background: User launches url
    Given the user launches the url

  @e2e @regressionTest @newRegisteredUser @wishList @visaCard
  Scenario Outline: New registered user should able to add multiple items to wishlist add selected item to cart remove wishlist and checkout in french
